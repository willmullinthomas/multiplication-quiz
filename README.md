# multiplication-quiz
A simple python (3.10.7) multiplication table quiz with a UI created in PyQt5. Users can configure their quiz based on the number of questions they want to try and what the largest factor in each equation can be (eg 9x9, 12x12).
